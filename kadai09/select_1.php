...
if($status1==false){
    ...
    while($result = $stmt1->fetch(PDO::FETCH_ASSOC)){
        ...
        $view1.='</td>';
        $view1.='<td>';
        $view1.='<a href="detail_1.php?id='.$result["id"].'&league=central">';
        $view1.='[詳細]';
        $view1.='</a>';
        $view1.='</td>';
        $view1.='</tr>';
...
if($status2==false){
    ...
    while($result = $stmt2->fetch(PDO::FETCH_ASSOC)){
        ...
        $view2.='</td>';
        $view2.='<td>';
        $view2.='<a href="detail_1.php?id='.$result["id"].'&league=pacific">';
        $view2.='[詳細]';
        $view2.='</a>';
        $view2.='</td>';
        $view2.='</tr>';
...
<header>
  <nav class="navbar navbar-default">
    <div class="container-fluid">
      ...
      <a class="navbar-brand" href="select_1.php">順位予想一覧</a>
      </div>
    </div>
  </nav>
</header>
